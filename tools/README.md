# Mizan Tooling — R1–R18 Validator
...
R1–R18 from the schema — it does **not** evaluate whether a hypothesis is
...
> validator (LLM-free, R1–R18 static checks only)".
...
kuralları (R1–R18) uygular — bir hipotezin *iyi* olup olmadığını değil,
...
> "basit pre-commit hook + şema doğrulayıcı (LLM'siz, yalnız R1–R18 statik
