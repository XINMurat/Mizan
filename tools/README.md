# Mizan Tooling — R1–R15 Validator
...
R1–R15 from the schema — it does **not** evaluate whether a hypothesis is
...
> validator (LLM-free, R1–R15 static checks only)".
...
kuralları (R1–R15) uygular — bir hipotezin *iyi* olup olmadığını değil,
...
> "basit pre-commit hook + şema doğrulayıcı (LLM'siz, yalnız R1–R15 statik
