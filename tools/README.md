# Mizan Tooling — R1–R22 Validator
...
R1–R22 from the schema — it does **not** evaluate whether a hypothesis is
...
> validator (LLM-free, R1–R22 static checks only)".
...
kuralları (R1–R22) uygular — bir hipotezin *iyi* olup olmadığını değil,
...
> "basit pre-commit hook + şema doğrulayıcı (LLM'siz, yalnız R1–R22 statik
